...
(* CORE_GENERATION_INFO="Maximum_hls_Maximum_hls,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12t-cpg238-2I,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.906000,HLS_SYN_LAT=1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=286,HLS_SYN_LUT=586,HLS_VERSION=2025_2}" *)
...
wire   [31:0] values_3;
wire   [31:0] ap_return;
wire   [31:0] maxv_3_fu_84_p3;
reg   [31:0] maxv_3_reg_102;
reg   [31:0] v_4_reg_108;
wire   [0:0] icmp_ln11_fu_64_p2;
wire   [31:0] maxv_2_fu_70_p3;
wire   [0:0] icmp_ln11_1_fu_78_p2;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln11_2_fu_92_p2;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        maxv_3_reg_102 <= maxv_3_fu_84_p3;
        v_4_reg_108 <= values_3;
    end
end
...
assign ap_return = ((icmp_ln11_2_fu_92_p2[0:0] == 1'b1) ? v_4_reg_108 : maxv_3_reg_102);
